# APEXPSO Research Papers Collection

This directory contains research papers related to the APEXPSO (Advanced Parameter Exploration CrossQ-SAC for PSO) algorithm and its foundational methodologies.
...
8. **SAC_SAPSO_2024_MDPI.pdf**
   ...
   - Key Contribution: Direct precursor to APEXPSO, combining SAC with PSO parameter adaptation
...
13. **CrossQ_2019_1902.05605.pdf**
    ...
    - Venue: ICLR 2024
    - Key Contribution: CrossQ optimization with BatchNorm and no target networks (used in APEXPSO)
...
16. **MultiObjective_RL_1809.06364.pdf**
    ...
    - Authors: Pitis, R.
    - ArXiv: 1809.06364
    - Key Contribution: Multi-objective reward handling in deep RL (relevant to APEXPSO's 4-component reward)
...
17. **Transformer_Attention_2017_1706.03762.pdf**
    ...
    - Venue: NeurIPS 2017
    - Key Contribution: Transformer architecture with self-attention (basis for APEXPSO's TransformerStateEncoder)
...
These papers provide the theoretical foundation and technical context for understanding APEXPSO:
...
**APEXPSO Repository**: C:\Users\PC\Desktop\Copy_of_New Folder - Copy\
