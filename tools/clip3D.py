...
def main():
    ...
    trims = {
        "_3D.pdf": {"left": 310, "bottom": 75, "right": 410, "top": 65},
    }
    ...
    # Filter pdf_files to ONLY include _3D.pdf
    all_files = os.listdir(fig_dir)
    pdf_files = [f for f in all_files if f.lower().endswith("_3d.pdf")]
    ...
    if processed_count == 0:
        print("No '_3D.pdf' figures found to process.")
