function [globalPath, convergenceHistory, parameterHistory, algorithmSpecificStats] = globalPathPlanningPSOTVAC(startPoint, goalPoint, dangerZones, terrainGrid, terrainX, terrainY, mapSize, popSize, maxIterations, initialW, initialC1, initialC2)
    ...
    % Only the acceleration coefficients vary with time; inertia is constant.
    ...
    w_const = initialW;           % inertia constant
    ...
    parameterHistory.w = [parameterHistory.w; w_const];
    ...
    for iter = 1:maxIterations
        ...
        [current_w, current_c1, current_c2] = adaptParametersTVAC(w_const, 0, 0, ...
            iter, maxIterations, w_const, c1Min, c1Max, c2Min, c2Max);
