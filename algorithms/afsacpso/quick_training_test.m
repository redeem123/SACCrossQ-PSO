% Quick Training Test for AFSACPSO
...
clc; clear;
fprintf('╔══════════════════════════════════════════════════════════╗\n');
fprintf('║         AFSACPSO Quick Training Test                    ║\n');
fprintf('╚══════════════════════════════════════════════════════════╝\n\n');
...
try
    [bestPath, bestFitness, fitnessHistory, agent, stateEncoder] = ...
        globalPathPlanningAFSACPSO(startPoint, goalPoint, dangerZones, ...
    ...
    figure('Name', 'AFSACPSO Training Progress');
    plot(1:length(fitnessHistory), fitnessHistory, 'b-o', 'LineWidth', 2);
    xlabel('Episode');
    ylabel('Best Fitness');
    title('AFSACPSO Learning Curve (Quick Test)');
    grid on;
