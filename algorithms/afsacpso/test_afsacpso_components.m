...
%   addpath(genpath('.'))
%   algorithms/afsacpso/test_afsacpso_components

clc;
fprintf('╔══════════════════════════════════════════════════════════╗\n');
fprintf('║         AFSACPSO SAC Component Testing Suite              ║\n');
fprintf('╚══════════════════════════════════════════════════════════╝\n\n');
...
try
    ...
    redqAgent = AFSACPSO_Agent(redqConfig);
    ...
    if testsPassed == totalTests
        ...
        fprintf('\n  AFSACPSO SAC stack is ready for testing.\n');
