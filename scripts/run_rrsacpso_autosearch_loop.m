function result = run_rrsacpso_autosearch_loop()
...
function evalResult = evaluateCandidate(repoRoot, rootOutputDir, candidate, roundIdx, stageName, numRuns, maxIterations, popSize)
    ...
    run_rrsacpso_research_cycle(numRuns, maxIterations);

    summaryPath = fullfile(outputDir, 'rrsacpso_variant_summary.csv');
