...
| Group | Current files |
|---|---|
| Experiment runners | `compare_algorithms.m`, `run_afsacpso_research_cycle.m`, `run_apex_full_loop_iteration.m`, `run_afsacpso_autosearch_loop.m` |
...
| Automation / support | `run_afsacpso_autosearch_daemon.sh`, `latex_build.ps1` |
...
- Use `run_afsacpso_research_cycle.m` for AFSACPSO component and ablation work.
